...
const entries = {
  ...
  factory: {
    ...
    sources: [resumeSource, pageSource('company-projects', '主页 · AI 批量化生产工厂')],
  },
  review: {
    ...
    sources: [resumeSource, pageSource('company-projects', '主页 · 危大方案智审平台')],
  },
  avatar: {
    ...
    sources: [resumeSource, pageSource('company-projects', '主页 · 展厅数字人')],
  },
  search: {
